...
- Alright I got home and I declared a default region in my variables.tf, added my service account as a artifact writer to my SPECIFIC repo, then I added redid the deploy.yml.
